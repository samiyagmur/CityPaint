    ...
    public class Pool : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            for (; poolCount < _loadPoolCount; poolCount++)
            {
                ...
                {
                    var poolObj = Instantiate(_cd_ObjectDatas.ObjectData[poolCount].PoolObject,poolHolder);
        ...
        private GameObject OnGetObjcetFromPool(PoolObjectType type)
        {
            ...
            {
                _outGoingObject = Instantiate(_cd_ObjectDatas.ObjectData[(int)type].PoolObject,poolHolder);
            }
            else
            {
