...
namespace PaintIn3D
{
	...
	public class P3dMaterialColoner : MonoBehaviour, IBrowsable
	{
		...
		private static List<P3dMaterialColoner> cachedMaterials;

		public static List<P3dMaterialColoner> CachedMaterials
		{
			get
			{
				if (cachedMaterials == null)
				{
					cachedMaterials = new List<P3dMaterialColoner>();
#if UNITY_EDITOR
					var scriptGuid  = P3dHelper.FindScriptGUID<P3dMaterialColoner>();

					if (scriptGuid != null)
					{
						foreach (var prefabGuid in UnityEditor.AssetDatabase.FindAssets("t:prefab"))
						{
							var material = P3dHelper.LoadPrefabIfItContainsScriptGUID<P3dMaterialColoner>(prefabGuid, scriptGuid);
...
namespace PaintIn3D
{
	...
	using TARGET = P3dMaterialColoner;
	...
	public class P3dMaterial_Editor : P3dEditor
	{
		...
		protected override void OnInspector()
		{
			...
			if (P3dMaterialColoner.CachedMaterials.Contains(tgt) == false && P3dHelper.IsAsset(tgt) == true)
			{
				P3dMaterialColoner.CachedMaterials.Add(tgt);
			}
		...
		{
			var material = new GameObject("Material").AddComponent<P3dMaterialColoner>();
